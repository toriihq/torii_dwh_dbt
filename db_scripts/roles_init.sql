...
grant select on all tables in schema DATA_VAULT_DEV.RAW_VAULT_DEV to role DATA_ENGINEER;
...
grant select on all tables in schema STAGE_DEV.RAW_STAGE_DEV to role DATA_ENGINEER;
